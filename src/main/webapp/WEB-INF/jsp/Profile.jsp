...
<body>
	...
	<div class="container">
		...
		<div class="row">
			...
			<spring:form action="profiles" class="form-horizontal" role="form"
						...
						<div class="form-group">
							...
							<div class="col-lg-8">
								<input class="form-control" type="text"
									value="${message.profileId }" name="profileId"
									readonly="readonly">
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-lg-8">
								<input class="form-control" type="text"
									value="${message.fullName}" name="fullName" readonly="readonly">
							</div>
						</div>
            ...
            <div class="col-lg-8">
              <input class="form-control" type="text" value="${profile.gender}" name="gender">
						...
						<div class="form-group">
							...
							<div class="col-lg-8">
								<input class="form-control" type="text"
									value="${message.contactNumber}" name="contactNumber"
									readonly="readonly">
							</div>
						</div>
						<%-- <div class="form-group">
            ...
            <div class="col-lg-8">
              <input class="form-control" type="date" value="${profile.dateOfBirth}" name="dateOfBirth" >
						...
						<div class="form-group">
							...
							<div class="col-lg-8">
								<input class="form-control" type="text"
									value="${message.emailId}" name="emailId" readonly="readonly">
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-md-8">
								<input class="form-control" type="text"
									value="${message.userName}" name="userName" readonly="readonly">
							</div>
						</div>
						<%--       <div class="form-group">
